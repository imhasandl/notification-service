...
// RespondWithErrorGRPC creates a formatted gRPC error response with the given code and message,
// logging the error details before returning the status error.
